...
order: 8
excerpt: 沿联邦、州、县与地方政府层级考察美国政治权力结构。
---
...
更为值得注意的是，国会人联络处的网络，实际上构成一个完整的信息系统。一个国家的立法机关如何立法？这是实际政治中至关重要的一个问题。立法机关只有得到充分的信息后才能制定出适应性较大的法律，同时能正确判断各项事务的轻重缓急，制定法律。如果没有一个完整的信息系统，每个国会人和国会如何能做出准确的判断？国会人联络处制度，加以现代化的通讯和交通手段，使这个信息网络有效地运转起来。此为政治和社会组织中的一个重要方面。
